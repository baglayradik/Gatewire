...
В [Examples/GatewireDemo](Examples/GatewireDemo) — приложение на SwiftUI с публичным API DummyJSON:
публичный каталог, вход, профиль в авторизованной зоне, автоматическое обновление токена
и журнал событий авторизации.

## Документация

Документация с руководствами «Работа с разными форматами API», «Авторизация» и
«Надёжность и безопасность» публикуется на [Swift Package Index](https://swiftpackageindex.com/baglayradik/Gatewire/documentation).
Локально её можно открыть в Xcode: **Product → Build Documentation**.
...
- [x] Документация и пример приложения
- [x] `0.1.0` — первый публичный выпуск
- [ ] Пилотное подключение к реальному проекту и доработки по его итогам
